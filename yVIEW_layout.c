...
/*===----                      individual elements                     ----===*/
/*====================------------------------------------====================*/
static void  o___FORMULA_________o () { return; }
...
char yVIEW_formula           (void) { return myVIEW.p_formula; }
